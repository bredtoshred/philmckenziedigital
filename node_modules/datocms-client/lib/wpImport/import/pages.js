...
function pages(dato, wp, schema, media, authors) {
  var resources, tick, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _loop, _iterator, _step;

  return regeneratorRuntime.async(function pages$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return regeneratorRuntime.awrap((0, _allPages["default"])('Fetching pages', wp.pages()));
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return regeneratorRuntime.awrap(tick(page.title.rendered, createAndPublish()));
