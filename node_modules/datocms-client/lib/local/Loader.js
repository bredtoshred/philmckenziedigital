...
function () {
  ...
  _createClass(Loader, [{
    ...
    key: "watch",
    value: function watch(notifier) {
      var _this2 = this;

      var _ref3, _ref4, watcher, disconnect, addEventListener, itemVersion, previewMode;

      return regeneratorRuntime.async(function watch$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              _context5.next = 5;
              return regeneratorRuntime.awrap(this.client.subscribeToChannel(this.siteId));
            ...
            case 5:
              ...
              addEventListener('site:upsert', function _callee() {
                ...
                return regeneratorRuntime.async(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return regeneratorRuntime.awrap(Promise.all([_this2.client.get('/site', {
                          include: 'item_types,item_types.fields'
              ...
              addEventListener("item:".concat(previewMode, ":upsert"), function _callee2(_ref5) {
                var ids, payload;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ids = _ref5.ids;
                        _context2.next = 3;
                        return regeneratorRuntime.awrap(_this2.client.items.all({
                          'filter[ids]': ids.join(','),
                          version: itemVersion
                        }, {
                          deserializeResponse: false,
              ...
              addEventListener('upload:upsert', function _callee3(_ref7) {
                var ids, payload;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ids = _ref7.ids;
                        _context3.next = 3;
                        return regeneratorRuntime.awrap(_this2.client.uploads.all({
                          'filter[ids]': ids.join(',')
                        }, {
                          deserializeResponse: false,
                          allPages: true
              ...
              addEventListener('upload:destroy', function (_ref8) {
                var ids = _ref8.ids;

                _this2.entitiesRepo.destroyEntities('upload', ids);
              });
              addEventListener('item_type:upsert', function _callee4(_ref9) {
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 6:
                        ...
                        id = _step.value;
                        _context4.next = 10;
                        return regeneratorRuntime.awrap(Promise.all([_this2.client.itemTypes.find(id, {}, {
                          deserializeResponse: false
                        }), _this2.client.items.all({
                          'filter[type]': id,
                          version: itemVersion
              ...
              addEventListener('item_type:destroy', function (_ref10) {
                var ids = _ref10.ids;
